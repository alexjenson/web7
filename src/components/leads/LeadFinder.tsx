    ...
    <div className="flex h-screen flex-col overflow-hidden bg-slate-50">
      ...
      <header className="flex items-center justify-between border-b border-slate-200 bg-white px-5 py-3">
        <div className="flex items-center gap-2">
          ...
          <span className="ml-2 hidden rounded-full bg-slate-100 px-2 py-0.5 text-[11px] font-medium text-slate-500 sm:inline">
            demo
          </span>
        </div>
        <div className="flex items-center gap-2">
        ...
        <main className="flex min-w-0 flex-1 flex-col">
          ...
          <div className="border-b border-slate-200 bg-white px-5 py-3">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <button
                onClick={() => downloadCsv(results, "leadhawk-search.csv")}
              ...
              {savedLeads.length === 0 ? (
                ...
                savedLeads.map((l) => (
                  ...
                  >
                    ...
                    <button
                      onClick={() => search.toggleSaved(l.id)}
      ...
      <LeadDetailDrawer
        ...
        isSaved={active ? search.saved.has(active.id) : false}
